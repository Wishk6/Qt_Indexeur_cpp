...
QString SearchLexer::Tokenize(QStringList input, DatabaseUtils dbUtils)
{
    setFileName(input);
...
QString SearchLexer::getQueryResult(QString sqlQuery, DatabaseUtils dbUtils)
{
    return dbManager.getDataWithParams(sqlQuery,getFileName());
}
